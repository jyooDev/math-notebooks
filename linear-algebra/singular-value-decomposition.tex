...
\end{lemma}
\begin{proof}
  Let $\{\sigma_1, \sigma_2, \ldots, \sigma_n\}$ be the eigenvalues of $P$. Then there exists a basis of eigenvectors $\{b_1, b_2, \ldots, b_n\}$ of $P$ such that $P b_i = \sigma_i b_i$ for $i = 1, 2, \ldots, n$. \\
  Define $Q$ to be a matrix of eigenvectors $\{b_1, b_2, \ldots, b_n\}$ of $P$ as columns. By definition of a basis, $Q$ is an orthogonal matrix and $P \cdot Q  = \begin{vmatrix}
  \sigma_1 b_1 & \sigma_2 b_2 & \ldots & \sigma_n b_n
  \end{vmatrix}$. Then we have
  \[
    Q^T P Q = Q^T \begin{vmatrix}
    \sigma_1 b_1 & \sigma_2 b_2 & \ldots & \sigma_n b_n
    \end{vmatrix} = \begin{vmatrix}
    \sigma_1 Q^T b_1 & \sigma_2 Q^T b_2 & \ldots & \sigma_n Q^T b_n
    \end{vmatrix} = \begin{vmatrix}
    \sigma_1 e_1 & \sigma_2 e_2 & \ldots & \sigma_n e_n
    \end{vmatrix} = D
  \]
\end{proof}
...
\begin{proof}
  ...
  Let $(\sigma_1, \sigma_2, \ldots, \sigma_n)$ be the singular values of $A$.
  ...
  Next, define $B = A \cdot C \cdot N$ where
  \[
    N = D^{-1} = \text{diag}(\sigma_1^{-1}, \sigma_2^{-1}, \ldots, \sigma_m^{-1}) \in M_{m \times m}(\R).
  \] and
  $B$ is an orthogonal matrix since $B^T B = I_m$.\\
  Finally, we have
\end{proof}
